							...
							<view :class="['item-tr',highlight&&isHighlight(item,index)?'current-row':'']"
	                          ...
	                          marginRight:ite.renders.length>1?'8px':'0'
									...
									<template v-else-if="ite.type==='selection'">
										<view class="checkbox-item">
											<tableCheckbox :primaryColor="primaryColor" @checkboxSelected="(e)=>checkboxSelected(e,item)" :cellData="item"
					...
					<view class="next-table-fixed">
						<view class="next-table-tbody">
	                       ...
	                       textAlign:item.align||'left'
									...
									<template v-if="item.type==='selection'">
										<view class="checkbox-item">
											<tableCheckbox :primaryColor="primaryColor" @checkboxSelected="(e)=>checkboxSelected(e,ite)" :cellData="ite"
												:checked="ite.checked" />
										</view>
									</template>
